...
## Project Structure
    ...
    ├── content_faith_recor_33375  # Django project configurations
...
1. Clone this repo and `cd content_faith_recor_33375`
...
2. Clone this repo and `cd content_faith_recor_33375`
